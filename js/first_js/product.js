(() => {
  ...
  class e {
            ...
            return (
              ...
              "error" !== this._dataValue
                ...
                : void this.popupLogging(
                  `РћР№ РѕР№, РЅРµ Р·Р°РїРѕР»РЅРµРЅ Р°С‚СЂРёР±СѓС‚ Сѓ ${t.classList}`
                )
            );
    ...
    open(e) {
      if (
        ...
        this.popupLogging(
          "РћР№ РѕР№, С‚Р°РєРѕРіРѕ РїРѕРїР°РїР° РЅРµС‚. РџСЂРѕРІРµСЂСЊС‚Рµ РєРѕСЂСЂРµРєС‚РЅРѕСЃС‚СЊ РІРІРѕРґР°. "
        );
    }
    close(e) {
      e &&
        ...
        (this.options.on.beforeClose(this),
          ...
          this.popupLogging("Р—Р°РєСЂС‹Р» РїРѕРїР°Рї"));
    }
    _getHash() {
      this.options.hashSettings.location &&
    ...
    popupLogging(e) {
      this.options.logging && console.log(`[РџРѕРїР°РїРѕСЃ]: ${e}`);
    }
  }
  let t = !0,
    s = (e = 500) => {
  ...
  Object.keys(v).forEach((e) => {
    Object.defineProperty(m.fn, e, { value: v[e], writable: !0 });
  });
  const w = m;
  function b(e, t = 0) {
  ...
  function ie({ swiper: e, extendParams: t, on: s, emit: i }) {
    ...
    function h(t) {
      ...
      if (
        ("container" !== e.params.mousewheel.eventsTarget &&
          (d = w(e.params.mousewheel.eventsTarget)),
      ...
      if (
        ...
        const t = { time: C(), delta: Math.abs(c), direction: Math.sign(c) },
          n =
            a &&
            t.time < a.time + 500 &&
            t.delta <= a.delta &&
    ...
    function m(t) {
      let s = e.$el;
      "container" !== e.params.mousewheel.eventsTarget &&
        (s = w(e.params.mousewheel.eventsTarget)),
        s[t]("mouseenter", d),
        s[t]("mouseleave", p),
        s[t]("wheel", h);
    }
    function f() {
      return e.params.cssMode
        ...
        : !e.mousewheel.enabled && (m("on"), (e.mousewheel.enabled = !0), !0);
    }
    function g() {
      return e.params.cssMode
        ? (e.wrapperEl.addEventListener(event, h), !0)
        : !!e.mousewheel.enabled && (m("off"), (e.mousewheel.enabled = !1), !0);
    }
    s("init", () => {
      ...
      s("destroy", () => {
        e.params.cssMode && f(), e.mousewheel.enabled && g();
      }),
      Object.assign(e.mousewheel, { enable: f, disable: g });
  }
  function ne(e, t, s, i) {
    const n = o();
    return (
  ...
  function co({ swiper: e, extendParams: t, on: s }) {
    function i(e, t) {
      const s = (function () {
        let e, t, s;
        return (i, n) => {
        ...
        setTranslate: function (t, s) {
          ...
          function o(t) {
            ...
            "slide" === e.params.controller.by &&
              ...
              ((r =
                ...
                (a = (s - e.minTranslate()) * r + t.minTranslate())),
          ...
          if (Array.isArray(n))
            for (let e = 0; e < n.length; e += 1)
              n[e] !== s && n[e] instanceof l && o(n[e]);
          else n instanceof l && s !== n && o(n);
        },
  ...
  window.addEventListener("load", function (e) {
    !(function () {
      if ((de(), document.querySelector(".swiper"))) {
        const e = new se(".product-thumbs", {
          modules: [re, le, ie, co],
          observer: !0,
          observeParents: !0,
          direction: "vertical",
          ...
          speed: 800,
          navigation: {
            nextEl: ".product-thumbs__nav.next",
            prevEl: ".product-thumbs__nav.prev",
          },
          on: {},
        }),
          t =
            new se(".product-slider", {
              modules: [re, le, oe, co],
              observer: !0,
              observeParents: !0,
              direction: "vertical",
              ...
              on: {
                slideChange: function () {
                  let counter = document.querySelector('#numberSlides');
                  counter.innerHTML = (this.activeIndex + 1) + '/' + slides_count.length;
                }
              },
              breakpoints: {
                320: {
          ...
          u = new se(".product-thumbs__popup", {
            modules: [re, le, ie], co,
            observer: !0,
            observeParents: !0,
            direction: "vertical",
          ...
          o = new se(".product-slider__popup", {
            modules: [re, le, oe, co],
            observer: !0,
            observeParents: !0,
            direction: "vertical",
        ...
        e.controller.control = u;
        t.controller.control = o;

        const productCardThumbsWrap = document.querySelector(".product-card__thumbs")
        const productPopupThumbsWrap = document.querySelector(".product-thumbs__popup")

        if (productCardThumbsWrap && productPopupThumbsWrap) {
          const productCardThumbs = productCardThumbsWrap.querySelector(".product-thumbs__swiper")
          const productPopupThumbs = productPopupThumbsWrap.querySelector(".product-thumbs__swiper")

          const sliderThumbsChange = (thumbsSlider, productSlider) => {
            const thumbsSlides = thumbsSlider.children
            for (let i = 0; i < thumbsSlides.length; i++) {
              thumbsSlides[i].onmouseover = () => productSlider.slideTo(i);
            }
          }

          sliderThumbsChange(productCardThumbs, t)
          sliderThumbsChange(productPopupThumbs, o)
        }
  ...
  document.querySelector(".solution") &&
    (() => {
      ...
      document.querySelector(".solution__close").onclick = () => {
