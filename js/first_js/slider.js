    ...
    class l {
        constructor(e, t = null) {
            if (
                ...
                e.length
                    ? (this.selectsInit(e),
                        this.setLogging(`РџСЂРѕСЃРЅСѓР»СЃСЏ, РїРѕСЃС‚СЂРѕРёР» СЃРµР»РµРєС‚РѕРІ: (${e.length})`))
                    : this.setLogging("РќРµС‚ РЅРё РѕРґРЅРѕРіРѕ select. РЎРїР»СЋ...zzZZZzZZz...");
            }
        }
        getSelectClass(e) {
            return `.${e}`;
            ...
            if (
                ...
                if ("click" === s) {
                    ...
                    "focusin" === s || "focusout" === s
                        ...
                        : "keydown" === s && "Escape" === e.code && this.selectsРЎlose();
            } else this.selectsРЎlose();
        }
        selectsРЎlose() {
